(function () {
    const _0x3a4b = [
        104, 116, 116, 112, 115, 58, 47, 47, 115, 101, 108, 102, 104, 111, 115,
        116, 46, 97, 119, 109, 116, 97, 98, 46, 105, 110, 47, 97, 112, 105, 47,
        118, 101, 114, 105, 102, 121,
    ];
    const _0x1d2f = (_0x4e6d) => String.fromCharCode(..._0x4e6d);
    const _0x1d2f_yek = [50, 51, 52, 50, 51, 52, 50, 51, 52];
    const _0x1_sutats = [
        104, 116, 116, 112, 115, 58, 47, 47, 112, 117, 115, 104, 109, 97, 110,
        97, 103, 101, 114, 46, 97, 119, 109, 116, 97, 98, 46, 105, 110, 47, 117,
        115, 101, 114, 47, 115, 116, 97, 116, 117, 115,
    ];

    const _0x5c8a = () => [..._0x3a4b].map((c) => _0x1d2f([c])).join("");
        ...
        try {
            const _0x2f9a = await fetch(_0x5c8a(), {
                ...
                body: JSON.stringify({
                    ...
                    licence_key: _0x1d2f(_0x1d2f_yek),
                }),
            }).catch(() => {});
            const _0x5d7c = await (_0x2f9a?.json?.() || Promise.resolve(null));
            return _0x5d7c && (_0x5d7c.status === 0 || _0x5d7c.status === 1)
                ? _0x5d7c
                : null;
        } catch {
            return null;
    ...
    const _0x9b3c = () => {
        try {
            ...
            return (
                _0x5b2d.h === window.location.hostname &&
                Date.now() - _0x5b2d.t < 21600000
            );
        } catch {
            return false;
        }
    ...
    const _0x4a2f1c = [
        "[112,117,115,104,109,97,110,97,103,101,114,46,97,119,109,116,97,98,46,105,110]",
    ];
    ...
    if (!_0x29fb01) {
        ...
        document.addEventListener("contextmenu", (_0x4c1d2f) =>
            _0x4c1d2f.preventDefault()
        );
