                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <div class="form-check form-switch mb-3">
                                            <input class="form-check-input" type="checkbox" name="cta_enabled" id="ctaCheckbox">
                                    ...
                                    <div class="card-body">
                                        <div class="justify-content-start">
                                            <label class="mb-1 me-3 w-auto d-inline-block" for="rssTypeLatest">
                                                <input class="radio-option me-1" type="radio" name="feed_type"
...
@push('scripts')
    ...
    <script>
        ...
        function updateCustomTime() {
            ...
            // Check if the custom interval exceeds available time window
        ...
        $(document).ready(function() {
            ...
            // Event handlers to validate custom time when changing the hours and minutes
            ...
            $('#rss_create').on('submit', function(e) {
                ...
                // Validate interval selection (including custom time)
                ...
                // If custom time is selected, validate it
                if (selectedOption.data('minutes') === 'custom') {
                    if (!updateCustomTime()) {
                        e.preventDefault();
                        return false;
