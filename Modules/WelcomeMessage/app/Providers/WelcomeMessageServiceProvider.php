...
namespace Modules\WelcomeMessage\Providers;
...
class WelcomeMessageServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'WelcomeMessage';

    protected string $nameLower = 'welcomemessage';
