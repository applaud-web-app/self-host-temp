...
namespace Modules\WelcomeMessage\Http\Middleware;
...
class CheckLicenseKey
{
    ...
    {
        try {
            $providedKey = decrypt(config('license.welcome_message_key'));
            $providedName = config('license.welcome_message_name');
