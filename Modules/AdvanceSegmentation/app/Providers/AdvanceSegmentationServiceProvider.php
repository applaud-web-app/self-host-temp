...
namespace Modules\AdvanceSegmentation\Providers;
...
class AdvanceSegmentationServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'AdvanceSegmentation';

    protected string $nameLower = 'advancesegmentation';
