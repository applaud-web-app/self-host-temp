                ...
                <div class="col-12">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <div class="site-content">
                            <h2 class="mb-0 me-3">Custom Prompt Configuration</h2>
                        ...
                        <div class="collapse show" id="wpPluginCard">
                            <div class="card-body">
                                ...
                                <div class="step-card">
                                    ...
                                    <button data-url="{{route('customprompt.download-plugin',[$domain->name])}}" type="button" class="btn download-plugin btn-outline-primary w-100 py-2">
                                ...
                                <div class="step-card">
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <code class="domain-key">&lt;script
                                            src='{{ route('api.push.custom-prompt', ['site' => $domain->name]) }}'&gt;&lt;/script&gt;</code>
    ...
    <script>
        $(function() {
            ...
            $('#verifySetup').on('click', function() {
                ...
                $.ajax({
                    url: '{{ route("customprompt.verify-integration") }}',
                    method: 'GET',
                    data: { domain: domain },
                    success(res) {
                        if (res.success) {
