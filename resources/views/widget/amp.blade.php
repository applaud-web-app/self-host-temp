                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-4 col-md-6">
                                    <div class="download-card p-3 border rounded-2 bg-white h-100">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="fas fa-file-code text-primary me-2"></i>
                                            <h6 class="mb-0">Firebase Messaging</h6>
                                        </div>
                                        <p class="small text-muted mb-3">Core functionality for push notifications</p>
                                        <a href="{{ asset('firebase-messaging.js') }}" class="btn btn-sm btn-outline-primary w-100" download>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="download-card p-3 border rounded-2 bg-white h-100">
                                        ...
                                        <p class="small text-muted mb-3">Supporting HTML for the widget</p>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="download-card p-3 border rounded-2 bg-white h-100">
                                        ...
                                        <p class="small text-muted mb-3">User permission interface</p>
...
&lt;/button&gt;</code></pre>
                            ...
                            <div class="mt-4 p-3 bg-white border rounded-2">
                                <h5 class="mb-3"><i class="fas fa-eye me-2 text-primary"></i>Button Preview</h5>
