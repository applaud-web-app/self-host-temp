                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start">
                                    <div class="form-group flex-grow-1">
                                        ...
                                        @isset($notification->target_url) value="{{ $notification->target_url }}" @endisset
                            ...
                            <div class="card-body">
                                <div class="row" id="metaForm">
                                    <div class="col-12 mb-3">
                                        ...
                                        @isset($notification->title) value="{{ $notification->title }}" @endisset
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea class="form-control emoji_picker notification" onkeyup="descriptionText(this.value)" name="description"
                                            id="description" required placeholder="Notification description" style="height: 100px;">@isset($notification->description){{ $notification->description }}@endisset</textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="userprofile">
                                            @php
                                                $defaultImageSrc = asset('images/default.png');
                                                $bannerImage = isset($notification->banner_image) ? $notification->banner_image : $defaultImageSrc;
                                            @endphp
                                            <img src="{{ $bannerImage }}" id="banner_image" alt="Banner"
                                            ...
                                            <div class="input-group">
                                                <input type="url" class="form-control" name="banner_image"
                                                    ...
                                                    aria-label="Banner Image URL" value="{{ $bannerImage }}"
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <div class="userprofile">
                                            @php
                                                $defaultIcon = asset('images/push/icons/alarm-1.png');
                                                $bannerIcon = isset($notification->banner_icon) ? $notification->banner_icon : $defaultIcon;
                                            @endphp
                                            <img src="{{ $bannerIcon }}" id="banner_icon"
                                    ...
                                    <div class="border p-3 rounded-1 mb-2" id="first_btn">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-12">
                                                <label for="titleInput1" class="form-label">Title: <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="titleInput1" placeholder="Click Here" onkeyup="btn_title_prv1(this.value)" name="btn_1_title" required>
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="custom-radio justify-content-start">
                                        <label class="mb-2 mb-lg-3 w-auto d-inline-block" for="segment_all">
                                            <input type="radio" name="segment_type" id="segment_all" value="all" checked>
                            ...
                            <div class="card h-auto">
                                <div class="card-body p-3">
                                    ...
                                    <div class="windows_view">
                                        <img src="{{ $bannerImage }}" id="message_image" class="feat_img img-fluid message_image"
                                            alt="">
                                        <div class="windows_body">
                                            ...
                                            <div class="preview_content d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <span class="fs-16 text-white prv_title" id="prv_title">{{ $notification->title ?? "Title Preview" }}</span>
                                                    <p class="card-text prv_desc" id="prv_desc">{{ $notification->description ?? "Preview of Description" }}</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="android_body mt-3">
                                            ...
                                            <div class="preview_content d-flex justify-content-between align-items-center">
                                                <div class="flex-grow-1">
                                                    <span class="fs-16 text-black prv_title" id="prv_title">{{ $notification->title ?? "Title Preview" }}</span>
                                                    <p class="card-text fs-14 prv_desc" id="prv_desc">{{ $notification->description ?? "Preview of Description" }}</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <img src="{{ $bannerIcon }}"
                                                        id="icon_prv" class="img-fluid" alt="Icon Preview">
                                            ...
                                            <img src="{{ $bannerImage }}" id="message_image"
