                    ...
                    <div class="collapse" id="scriptCodeCard">
                        <div class="card-body">
                            <div class="step-card">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <code class="domain-key">&lt;script src='{{ route('api.push.notify') }}'&gt;&lt;/script&gt;</code>
                                    <button class="btn px-3 py-2 btn-sm copy-btn btn-outline-dark">
                                        <i class="fas fa-copy me-1"></i> Copy
                                    </button>
                                </div>
                            ...
                            <div class="step-card">
                                ...
                                @php
                                    $downloadSw = route('domain.download-sw');
                                    $param = ['domain' => $domain->name];
                                    $downloadSwEncryptUrl = encryptUrl($downloadSw, $param);
                                @endphp
                                <button data-url="{{ $downloadSwEncryptUrl }}" class="btn download-btn btn-outline-primary w-100 py-2">
...
<script>
    $(document).ready(function() {
        ...
        $('.download-btn').click(function() {
            ...
            setTimeout(() => {
                $(this).prop('disabled', false).html('<i class="fas fa-download me-2"></i> Download apluselfhost-messaging-sw.js');
            }, 1000);  
        });
    });
</script>
